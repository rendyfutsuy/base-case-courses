...
VALUES
-- course_level
    (uuid_generate_v7(), 'COURSE_LEVEL_ALL_LEVEL', 'ALL LEVEL', 'all_level', 'course_level', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
    (uuid_generate_v7(), 'COURSE_LEVEL_BEGINNER', 'BEGINNER', 'beginner', 'course_level', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
    (uuid_generate_v7(), 'COURSE_LEVEL_INTERMEDIATE', 'INTERMEDIATE', 'intermediate', 'course_level', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
    (uuid_generate_v7(), 'COURSE_LEVEL_ADVANCE', 'ADVANCE', 'advance', 'course_level', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
